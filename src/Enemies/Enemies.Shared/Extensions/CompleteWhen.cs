...
namespace Enemies.Extensions
{
    class CompleteWhenOperation : IAsyncOperation
    {
        TaskCompletionSource<bool> _tcs;
        Func<GameTime, bool> _checkCompletion;
        ...
        public System.Threading.Tasks.Task Task { get { return _tcs.Task; } }

        public bool Continue(Microsoft.Xna.Framework.GameTime gameTime)
        {
